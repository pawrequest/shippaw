...
#             "deliv name": "Customer", "deliv address": "address", "deliv deliveryContact": "deliveryContact", "deliv email": "email",
...
com_fields = {'Delivery Tel': 'phone', 'Delivery Email': 'email', 'Delivery Address': 'address', 'Send Out Date': 'send date',
     ...
     'Deliv Address': 'address', 'Deliv Contact': 'deliveryContact', 'Deliv Email': 'email', 'Deliv Postcode': 'postcode',
     'Deliv Telephone': 'tel'}
